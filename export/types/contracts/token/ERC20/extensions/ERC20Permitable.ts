...
export interface ERC20PermitableInterface extends utils.Interface {
  functions: {
...
export interface ERC20Permitable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20PermitableInterface;
