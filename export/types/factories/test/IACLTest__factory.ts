...
import type { IACLTest, IACLTestInterface } from "../../test/IACLTest";
...
export class IACLTest__factory {
  static readonly abi = _abi;
  static createInterface(): IACLTestInterface {
    return new utils.Interface(_abi) as IACLTestInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IACLTest {
    return new Contract(address, _abi, signerOrProvider) as IACLTest;
  }
}
